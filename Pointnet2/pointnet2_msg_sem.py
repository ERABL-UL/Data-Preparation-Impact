...
class PointNet2SemSegMSG(PointNet2SemSegSSG):
    def _build_model(self):
        ...
        self.FP_modules.append(PointnetFPModule(mlp=[256 + self.hparams.in_feats, 128, 128]))
        ...
        self.fc_lyaer = nn.Sequential(
            ...
            nn.ReLU(True),
            nn.Dropout(0.5),
            nn.Conv1d(128, self.hparams.num_classes, kernel_size=1),
        )
